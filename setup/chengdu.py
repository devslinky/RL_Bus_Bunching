...
class CD_Route3_Route_Schema(Route_Schema):
    ...
    def _define_od_table(self) -> Dict[str, Dict[str, Dict[str, float]]]:
        ...
        for idx, origin_stop in enumerate(visit_seq_stop_ids):
            ...
            if len(dest_stops) > 0:
                # print('origin_stop:', origin_stop, 'pax_arrival_rate:', pax_arrival_rate)
    ...
    def _define_bus_capacity(self) -> Dict[str, int]:
        """Define bus capacity for Chengdu Route 3.

        Typical city bus capacity: 80-120 passengers.
        Using 80 as a conservative estimate.
        """
        # return {'3': 80}
        return {'3': 100}
