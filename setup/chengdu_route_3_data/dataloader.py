...
class DataLoader:
    def __init__(self) -> None:
        ...
        self.virtual_data = pd.read_json(
            'setup/chengdu_route_3_data/data_virtual.jsonl', orient='records', lines=True
        )
        self.lambda_data = pd.read_json(
            'setup/chengdu_route_3_data/lamda_station.jsonl', orient='records', lines=True
        )
        self.spacing_data = pd.read_json(
            'setup/chengdu_route_3_data/spacing.jsonl', orient='records', lines=True
        )
        self.day_ids = [8, 9, 10]
