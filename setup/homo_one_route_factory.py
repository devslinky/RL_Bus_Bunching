...
class Homo_One_Route_Components_Factory:
    ...
    def __init__(self, blueprint: Blueprint) -> None:
        ...
        self._pax_operation = PaxOperation(pax_arrival_type=pax_arrival_type, pax_board_time_mean=pax_board_time_mean,pax_board_time_std=pax_board_time_std, pax_board_time_type=pax_board_time_type,                                           pax_alight_time_mean=None, pax_alight_time_std=None,                                           pax_alight_time_type=None)
