...
class Terminal:
    ...
    def dispatch(self, t: int, force_dispatch: bool) -> List[Bus]:
        """Dispatch buses from this terminal.

        Args:
            t: current time
            force_dispatch: whether to force dispatch buses regardless of schedule
        Returns:
        ...
        for route in self._routes:
            ...
            # if t % int(route.schedule_headway) == 0 and t > 0 or force_dispatch:
