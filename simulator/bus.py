...
class Bus:
    ...
    def __init__(self, bus_id: str,
        ...
        # print(f'Initialize Bus {self._bus_id} on Route {self._route_id} with capacity {self._capacity}')
        # xxx
    ...
    def pax_count(self) -> int:
        ...
        return len(self._paxs)

    @property
    def has_room(self) -> bool:
        """Check if the bus has room for more passengers."""
        return len(self._paxs) < self._capacity

    @property
    def remaining_capacity(self) -> int:
        """Number of additional passengers that can board."""
        return max(0, self._capacity - len(self._paxs))
