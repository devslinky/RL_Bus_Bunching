...
class Tracer:
    ...
    Methods:
        ...
        get_metric(self, route_stop_ids: Dict[str, List[str]],
                    ...
                    'hold_time', 'queueing_delay', 'pax_boarding_rejection']]) -> Dict
    '''
    ...
    def get_metric(self, route_stop_ids: Dict[str, List[str]],
                   ...
                   metric_names: List[Literal['headway_std', 'schedule_deviation',
                                              'pax_in_vehicle_wait_time', 'pax_out_vehicle_wait_time',
                                              'hold_time', 'queueing_delay',
                                              'pax_boarding_rejection']]) -> Dict:
        ...
        if 'pax_boarding_rejection' in metric_names:
            total_rejected = 0
            last_snapshot = self._snapshots[-1]
            for stop_id, stop_snap in last_snapshot.stop_snapshots.items():
                total_rejected += stop_snap.rejected_pax_count
            metrics['pax_boarding_rejection'] = total_rejected
